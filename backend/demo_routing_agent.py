    ...
    return [
        ...
        },
        {
            ...
            "data": {
                ...
                "stress_management": 2,
                "wellness_goals": ["sleep_improvement"],
                "preferred_support_type": "individual_therapy",
        ...
        },
        {
            ...
            "data": {
                ...
                "stress_management": 1,
                "wellness_goals": ["stress_reduction", "mindfulness"],
                "preferred_support_type": "individual_therapy",
                "urgency_level": "within_week",
            },
        },
        {
            ...
            "data": {
                ...
                "exercise_frequency": "several_weekly",
                "stress_management": 3,
                "wellness_goals": ["work_life_balance", "productivity", "mindfulness"],
    ...
    for i, case in enumerate(test_cases, 1):
        ...
        if crisis_indicator >= 1:
            ...
            if phq9_score > gad7_score:
                ...
                reasoning = (
                    f"Mild-moderate anxiety (GAD-7: {gad7_score}) - anxiety management"
                )
            confidence = 0.75
        else:
            category = "✨ LIFESTYLE COACHING"
            reasoning = (
                "Low clinical scores - wellness and lifestyle optimization focus"
            )
            confidence = 0.80
...
def demo_langchain_routing():
    ...
    try:
        ...
        if not os.getenv("OPENAI_API_KEY"):
            print(
                "⚠️  OpenAI API key not found. Set OPENAI_API_KEY environment variable to test LangChain routing."
            )
...
def show_clinical_info():
    ...
    assessments = {
        ...
        "PCL-5 Brief (PTSD Checklist for DSM-5)": {
            ...
            "interpretation": {"0-19": "Low trauma symptoms", "20+": "Probable PTSD"},
