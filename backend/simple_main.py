            ...
            "sections": [
                ...
                },
                {
                    ...
                    "questions": [
                        {
                            "id": "pcl5_1",
                            "text": "Repeated, disturbing memories, thoughts, or images",
                            "scale": "0-4",
                        },
                        {
                            "id": "pcl5_2",
                        ...
                        {
                            "id": "pcl5_3",
                            "text": "Suddenly acting or feeling as if a stressful experience were happening again",
                            "scale": "0-4",
                        },
                        {
                            "id": "pcl5_4",
                        ...
                        {
                            "id": "pcl5_5",
                            "text": "Having physical reactions when reminded of a stressful experience",
                            "scale": "0-4",
                        },
                    ],
                },
                {
                    ...
                    "questions": [
                        ...
                        {
                            "id": "lifestyle_3",
                            "text": "How would you rate your current stress management?",
                            "scale": "1-5",
                        },
                        {
                            "id": "lifestyle_4",
...
def route_user(scores: Dict[str, int]) -> RoutingResult:
    ...
    suicidal_ideation = any(
        k.startswith("phq9_9") and v > 0
    ...
    if depression_severe and anxiety_severe:
        category = (
            "DEPRESSION" if scores["depression"] > scores["anxiety"] else "ANXIETY"
        )
        confidence = 0.85
    ...
    risk_level = (
        "HIGH"
        if (depression_severe or anxiety_severe)
        else (
            "MODERATE"
            if (depression_moderate or anxiety_moderate or trauma_moderate)
            else "LOW"
        )
    )
