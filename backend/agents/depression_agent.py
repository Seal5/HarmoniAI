...
class DepressionAgent:
    ...
    def get_initial_assessment(self, user_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        crisis_indicator = user_data.get('clinical_scores', {}).get('crisis_indicator', 0)
        ...
        return {
            ...
            "immediate_actions": self._get_immediate_actions(phq9_score, crisis_indicator),
            "treatment_plan": self._create_treatment_plan(depression_profile, phq9_score),
            "behavioral_interventions": self._get_behavioral_interventions(),
            "safety_planning": self._create_safety_plan() if crisis_indicator >= 1 else None
        }
    ...
    def _get_immediate_actions(self, phq9_score: int, crisis_indicator: int) -> List[str]:
    ...
    def _create_treatment_plan(self, depression_profile: Dict[str, Any], phq9_score: int) -> Dict[str, Any]:
